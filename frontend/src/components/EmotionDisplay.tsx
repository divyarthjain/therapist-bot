...
export function EmotionDisplay({ emotionState, onClose }: Props) {
  if (!emotionState) {
    return (
      <div className="emotion-display">
        <div className="emotion-display__header">
          <h3 className="emotion-display__title">Emotional State</h3>
          {onClose && (
            <button className="emotion-display__close" onClick={onClose}>×</button>
          )}
        </div>
        <div className="emotion-display__content">
  ...
  return (
    <div className="emotion-display">
      <div className="emotion-display__header">
        <h3 className="emotion-display__title">Analysis</h3>
        {onClose && (
          <button className="emotion-display__close" onClick={onClose}>×</button>
        )}
      </div>
